...
export default function RhythmPage() {
  ...
  return (
    <DetailScreen title="관계 기록">
      {/* 리듬 요약 카드 */}
      <div style={{ background: cardTone, borderRadius: "26px", padding: "26px 22px", marginBottom: "16px" }}>
      ...
      {/* 주간 연락 흐름 */}
      <div style={{ background: "#FFFBF2", borderRadius: "26px", padding: "18px", border: "1px solid #E8DECF", marginBottom: "14px" }}>
      ...
      {/* 맥락 안내 */}
      <div style={{ background: "#D8E0A6", borderRadius: "26px", padding: "16px 18px", marginBottom: "14px" }}>
